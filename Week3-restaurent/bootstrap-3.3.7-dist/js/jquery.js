...
<style is="custom-style" css-build="shadow">html {
  ...
  --cr-actionable_-_cursor:  pointer;;
    ...
    --cr-paper-icon-button-margin_-_-webkit-margin-end:  var(--cr-icon-ripple-margin); --cr-paper-icon-button-margin_-_-webkit-margin-start:  var(--cr-icon-ripple-margin);
...
</div><script src="chrome://downloads/crisper.js"></script></body></html>